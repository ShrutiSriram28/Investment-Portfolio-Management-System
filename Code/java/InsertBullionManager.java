...
public class InsertBullionManager extends HttpServlet{
      ...
      throws ServletException, IOException {
		...
		try {
            ...
            String sql = "SELECT * FROM purchased_bullion WHERE username ='" + request.getParameter("username") + "' AND scheme = '" + request.getParameter("scheme") +
            ...
            if(rs.next())
            {
                ...
                sql = "UPDATE purchased_bullion SET quantity=" + total_quantity + ", net = " +  total_net + " WHERE username ='" + request.getParameter("username") + "' AND scheme = '" + request.getParameter("scheme") +
                "' AND purchase_price = " + request.getParameter("purchase_price") + " AND price = " + request.getParameter("price");
