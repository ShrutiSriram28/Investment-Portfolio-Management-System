...
public class InsertMF extends HttpServlet{
      ...
      throws ServletException, IOException {
		...
		try {
            ...
            String sql = "SELECT * FROM purchased_mf WHERE username ='" + request.getParameter("status") + "' AND scheme = '" + request.getParameter("scheme") +
            ...
            if(rs.next())
            {
                ...
                sql = "UPDATE purchased_mf SET amount=" + total_amount + ", units = " +  total_units + " WHERE username ='" + request.getParameter("status") + "' AND scheme = '" + request.getParameter("scheme") +
                "' AND purchase_nav = " + request.getParameter("purchase_nav") + " AND nav = " + request.getParameter("nav");
