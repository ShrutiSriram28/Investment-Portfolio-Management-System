...
public class SellBullionManager extends HttpServlet{
      ...
      throws ServletException, IOException {
		...
		try {
            ...
            if(rs1.next())
            {
                float existing_gain = rs1.getFloat("bullion");
                ...
                String sql2 = "UPDATE realised_gain SET bullion=" + new_gain + " WHERE username ='" + username + "'";
