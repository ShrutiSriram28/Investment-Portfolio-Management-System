...
public class InvestorLoginValidate extends HttpServlet {
        ...
        try {
            ...
            String sql = "SELECT * FROM investor_login WHERE email = '" + email + "'";
            ...
            sql = "SELECT username FROM investor_login WHERE email = '" + email + "'";
